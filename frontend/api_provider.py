"""
Call API providers. [Source] https://github.com/lmarena/FastChat-dev/blob/yonghyun/txt2music-dev/fastchat/serve/txt2music/music_api_provider.py
"""
...
if __name__ == "__main__":
    ...
    provider = get_music_api_provider(
        "music_model",
        base_url="http://treble.cs.cmu.edu:45912",
        check_interval=1.0,
        max_wait_time=300.0,
    )

    # Generate music
    response = provider.generate_music(
        prompt="Create an upbeat electronic dance track with a strong bass line",
    )
    ...
    if response.audio_data:
        ...
        print(f"Error generating music: {response.error}")