"""
Additional information of the models. [Source] https://github.com/lmarena/FastChat-dev/blob/yonghyun/txt2music-dev/fastchat/model/model_registry.py
"""
...
def get_model_info(name: str) -> ModelInfo:
    if name in model_info:
        ...
        return ModelInfo(
            name, "", "Register the description at music-arena/frontend/model/model_registry.py"
        )
...
# register_model_info(
#     ["glm-4-plus", "glm-4-0520", "glm-4-0116", "glm-4-plus-0111"],
#     "GLM-4",
...
# register_model_info(
#     ["athene-70b", "athene-70b-0725", "im-a-little-birdie", "athene-v2-chat"],
#     "Athene-70B",
...
#     "Text-to-image model by Ideogram",
# )
...
#     "Text-to-image model by Recraft",
# )

# register_model_info(
#     ["flux-1.1-pro", "flux-1-dev-fp8", "flux-1-schnell-fp8"],
#     "Flux 1.1 Pro",
#     "https://blackforestlabs.ai/announcing-flux-1-1-pro-and-the-bfl-api/",
#     "Text-to-image model by Black Forest Labs",
# )