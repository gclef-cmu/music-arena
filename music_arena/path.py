...
SYSTEMS_PRIVATE_DIR = REPO_DIR / "systems_private"
...
CONTAINER_SYSTEMS_PRIVATE_DIR = CONTAINER_REPO_DIR / "systems_private"
...
if EXECUTING_IN_CONTAINER:
    ...
    assert SYSTEMS_PRIVATE_DIR == CONTAINER_SYSTEMS_PRIVATE_DIR
