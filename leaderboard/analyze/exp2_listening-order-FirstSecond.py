...
def run_combined_analysis(log_dir: str):
    ...
    filename = os.path.join(OUTPUT_DIR, "exp2_listening-order-FirstSecond.png")
...
"""
python analyze/exp2_listening-order-FirstSecond.py > analyze/exp2_listening-order-FirstSecond.txt
"""