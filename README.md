...
For the full scoring implementation, see [`components/leaderboard/ma_leaderboard/scoring.py`](components/leaderboard/ma_leaderboard/scoring.py).
...
The leaderboard can be reproduced by anyone from the public HuggingFace dataset — no credentials required:
