![Music Arena banner](components/frontend/ma_frontend/static/banner.png)

# Music Arena

Music Arena is a platform for comparing text-to-music generation systems in a battle format. Users can generate music from text prompts and vote on their preferences to create leaderboards. See our [paper](https://arxiv.org/abs/2507.20900) for more details. For the leaderboard preparation code, please see [this repository](https://github.com/gclef-cmu/music-arena-leaderboard).
